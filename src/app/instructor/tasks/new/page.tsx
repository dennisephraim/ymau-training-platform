...
export default function NewTaskPage() {
  ...
  const [questions, setQuestions] = useState<TaskQuestion[]>([
    { id: crypto.randomUUID(), text: '', order: 0, responseType: 'text' },
  ]);
    ...
    <div className="space-y-6 animate-fade-in max-w-4xl">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-500">Create a new task with questions for delegates</p>
        </div>
      </div>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500">
              Users with these roles will see this task in their dashboard
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-gray-500">
              Tasks past the due date will show as overdue
            </p>
          </div>
